...
import com.example.btl.activity.MainActivity;
import com.example.btl.activity.TeritActivity;
    ...
    public void onClick(View action) {
        if (action == left) {
            ...
            if (gameState.status) {
                ...
                pause.setText(R.string.start_new_game);
                Intent intent = new Intent(Game.this, TeritActivity.class);
